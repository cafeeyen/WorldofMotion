...
public class ProblemGenerator : MonoBehaviour
{
    ...
    public Text[] ansText;
    public int randomChoice,randomQuestion;
	...
	public void newProblem()
    {
        ...
        else if (PlayerPrefs.GetInt("Lesson") > 1)
        {
            ...
            if (PlayerPrefs.GetInt("Lesson") == 2) //Motion
            {
            ...
            else if (PlayerPrefs.GetInt("Lesson") == 3) //Force
            {
                switch (randomQuestion)
                {
                    case 1:
            ...
            else if (PlayerPrefs.GetInt("Lesson") == 4)//Friction
            {
                switch (randomQuestion)
                {
                    case 1:
            ...
            else if (PlayerPrefs.GetInt("Lesson") == 5)//Gravity
            {
                switch (randomQuestion)
                {
                    case 1:
            ...
            falseAnswer[2] = answer * Random.Range(2, 4);
